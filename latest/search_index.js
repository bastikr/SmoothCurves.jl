...
{
    "location": "clothoid.html#Power-series-1",
    "page": "Clothoid",
    "title": "Power series",
    "category": "section",
    "text": "x(s) = int_0^s cos(lambda t^2) mathrmdt\n     = sum_n=0^infty (-1)^n fracx^4n+1(2n)(4n+1)\n     = x - frac110 x^5 + frac1216 x^9 - frac19360 x^13 + frac1685440 x^17 - frac176204800 x^21 + frac111975040000 x^25 - frac12528170444800 x^29 + dots\n\ny(s) = int_0^s sin(lambda t^2) mathrmdt\n     = sum_n=0^infty (-1)^n fracx^4n+3(2n+1)(4n+3)\n     = frac13 x^3 - frac142 x^7 + frac11320 x^11 - frac175600 x^15 + frac16894720 x^19 + frac1918086400 x^23 + frac1168129561600 x^27 + frac140537905408000 x^31 + dots"
},

{
    "location": "clothoid.html#Fitting-1",
    "page": "Clothoid",
    "title": "Fitting",
    "category": "section",
...
{
    "location": "api.html#SmoothCurves.standardlength",
    "page": "API",
    "title": "SmoothCurves.standardlength",
    "category": "function",
